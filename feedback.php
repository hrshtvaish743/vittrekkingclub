    ...
    <section id="contact" class="container content-section text-center">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <p>Secretory : Prasanna Prakash</p>
                <p>Phone No. : +919788747999</p>
                <p>Kindly Fill The Feedback Form</p>
                <form action="feeddone.php" method="post">
                <div class="text-center">
                    <p>Name: <input type="text" name="name">
                    Register No: <input type="text" name="regno"></p><br>
                    <p>Phone No. : <input type="text" name="phone">
                    E-mail: <input type="text" name="email"></p><br>
                    <p>Your Feedback: <input type="text" name="feed"></p><br>
                </div>
                ...
                <ul class="list-inline banner-social-buttons">
                    <li>
                        <a href="https://www.facebook.com/VitTrekkingClub" class="btn btn-default btn-lg"><i class="fa fa-facebook fa-fw"></i> <span class="network-name">Facebook</span></a>
                    </li>
                </ul>
            </div>
        </div>
