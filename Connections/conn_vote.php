...
# Type="MYSQL"
# HTTP="true"
$hostname_conn_vote = "mysql.hostinger.in";
$database_conn_vote = "u828621389_trek";
...
$conn_vote = new mysqli($hostname_conn_vote, $username_conn_vote, $password_conn_vote) or die('Can\'t create connection: '.mysql_error());
